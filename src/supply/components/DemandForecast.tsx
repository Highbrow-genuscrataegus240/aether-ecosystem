...
import { calculateLocalForecast, generateAIDemandForecast, DemandForecastResult } from '../services/forecastService';
...
export const DemandForecast: React.FC<DemandForecastProps> = ({ analytics, sales }) => {
    ...
    // Calculate forecasts
    const forecasts = useMemo(() => calculateLocalForecast(analytics, sales), [analytics, sales]);
    ...
    const getConfidenceBadge = (confidence: string) => {
        switch (confidence) {
            case 'high': return <span className="px-2 py-0.5 text-[10px] rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">HIGH</span>;
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="rounded-xl border border-border bg-card p-4">
                    ...
                    <p className="text-2xl font-bold text-emerald-400">{stats.growing}</p>
                </div>
                <div className="rounded-xl border border-border bg-card p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {stats.topGrower && (
                        <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/5 p-4">
                            ...
                            <p className="text-sm font-medium text-emerald-400">{stats.topGrower.productName}</p>
